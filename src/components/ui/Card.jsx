...
const Card = ({ src, title, description, titleButton, href }) => {
	return (
		<div className="relative size-full">
			...
			>
				<LazyVideo src={src} loop muted autoPlay playsInline preload="metadata" className={"absolute left-0 top-0 size-full object-cover object-center"} />
			</Suspense>
			...
			<div className=" relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
				...
				{titleButton && href && <Button title={titleButton} containerClass="!bg-yellow-300 flex-center gap-1" href={href} />}
			</div>
		</div>
	);
};
